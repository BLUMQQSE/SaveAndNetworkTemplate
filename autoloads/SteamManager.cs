...
public partial class SteamManager : NetworkManager, IListener
{
    ...
    private void AddFriendConnectionPair(uint connectionID)
    {
        if (friendToAdd.Id != 0)
        {
            ...
            EventSystem.Instance.PushEvent(EventID.OnPlayerConnectedToServer_Server, friendToAdd);
    ...
    public override void _Ready()
    {
        ...
        EventSystem.Instance.Subscribe("AddFriendConnectionPair", this);
    ...
    {
        if (e.ID == "AddFriendConnectionPair")
        {
            AddFriendConnectionPair((uint)e.Parameter);
        }
    }
...
public class SteamConnectionManager : ConnectionManager
{
    public override void OnConnected(ConnectionInfo info)
    {
        ...
        EventSystem.Instance.PushEvent(EventID.OnPlayerConnectedToServer_Client);
...
public class SteamSocketManager : SocketManager
{
    public override void OnConnected(Connection connection, ConnectionInfo info)
    {
        ...
        EventSystem.Instance.PushEvent("AddFriendConnectionPair", connection.Id);
    ...
    public override void OnDisconnected(Connection connection, ConnectionInfo info)
    {
        ...
        foreach (var item in SteamManager.Instance.SteamIdToConnection)
        {
            ...
            {
                if (!NetworkDataManager.Instance.OwnerIdToPlayer.ContainsKey(item.Key)) return;
        ...
        IntPtr data, int size, long messageNum, long recvTime, int channel)
    {
        ...
        //GD.Print("Server Reveived Message...");
        JsonValue info = DataConverter.ParseData(data, size);
    ...
    public void SendBroadcast(string data, bool realiable = true)
    {
        ...
        {
            //GD.Print("Sending data to: " +  item.Id);
    ...
    public void SendMessage(SteamId client, string data, bool realiable = true)
    {
        ...
        foreach (var item in Connected.Skip(1).ToArray())
        {
            ...
            {
                //GD.Print("Sending direct data to only: " + item.Id);
                item.SendMessage(DataConverter.SealData(data), s);
            }
        }
    }
